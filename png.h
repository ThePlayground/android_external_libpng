...
PNG_EXPORT(240, void,png_build_index, (png_structp png_ptr));
PNG_EXPORT(241, void,png_configure_decoder, (png_structp png_ptr, int *row_offset, int pass));
#endif
 ...
 */
PNG_EXPORT(242, void, png_set_seek_fn, (png_structp png_ptr,
